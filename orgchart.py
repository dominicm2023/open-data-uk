...
def render_3d(site_url: str) -> str:
    ...
    body_html = (
        ...
        '<ul><li><b>Click</b> a glowing post, a label, or a name in the list to open it: a department, then a body, then the posts beneath a post.</li>'
        '<li><b>Click empty space</b>, press <b>Esc</b>, or use the trail at the top to go back up. The browser&#39;s back button works too.</li>'
        '<li><b>Drag</b> to turn, <b>wheel</b> or <b>+</b>/<b>−</b> to zoom, arrow keys to turn and tilt.</li>'
