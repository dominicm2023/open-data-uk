...
No longer served from here. From 4 September 2026 the campaigning arm
lives in its own repository and uses this site's public API like anyone
else. The old `/lab` basic_auth block has been removed from the Caddyfile.
